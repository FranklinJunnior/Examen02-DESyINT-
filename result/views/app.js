var app = angular.module('movieGenres', []);
...
function getPercentages(a, b, c, d, e) {
  ...
  if (total > 0) {
    ...
    result.b = Math.round(b / total * 100);
    result.c = Math.round(c / total * 100);
    result.d = Math.round(d / total * 100);
    result.e = Math.round(e / total * 100);
  } else {
